%global commit_id f13afeb
%global commit_date 20160103
%global checkout %{commit_date}git%{commit_id}
...
Name: mutt-kz
Version: 1.5.23.1
Release: 1%{?dist}.%{checkout}
Epoch: 5
# The entire source code is GPLv2+ except
# pgpewrap.c setenv.c sha1.c wcwidth.c which are Public Domain
License: GPLv2+ and Public Domain
Group: Applications/Internet
Source: %{name}-%{version}-%{commit_id}.tar.gz
...
program built on top of the xapian database library.
...
%changelog
* Thu Feb 04 2016 Lars Kellogg-Stedman <lars@redhat.com> - f13afeb
- updated to commit f13afeb

* Wed Feb 05 2014 Karel Zak <kzak@redhat.com> - 5:1.5.22.1-1
- upgrade to mutt-kz v1.5.22.1, spec file based on Fedora 20 mutt 
  and fatka's mutt-kz repository (thanks to Suvayu Ali)
